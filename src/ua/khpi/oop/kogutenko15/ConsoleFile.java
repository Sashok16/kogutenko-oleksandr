        ...
        while (true)///нескінченний цикл який дозволяє працювати програмі
        {
            try {
                ...
                switch (key)///пошук введеної команди
                {
                    ...
                    case 7:
                        System.out.print("enter name of file WITH extension (.txt, .bin etc.): ");

                        //regex
                        String fileName_7 = in.nextLine();
                        System.out.println("File path is " + file.getAbsolutePath() + "/" + fileName_7);
                        //
                        return new File(file.getAbsolutePath() + "/" + fileName_7);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                switch (key)///пошук введеної команди
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        System.out.print("enter name of file WITH extension: ");
                        //in.nextLine();
                        //regex
                        String fileNameIn_5 = in.nextLine();
                        //
                        file = new File(file.getAbsolutePath() + "/" + fileNameIn_5);
                        if (file.isFile() == true) {
