...
public class InteractiveConsole {
    ...
    ThreadTask th_list = new ThreadTask();
            ...
            while (check) {
                ...
                switch (input) {
                    ...
                    case "4":
                        ...
                        int id = sc.nextInt();
                        //
                        if (id < 0 || id > th_list.list.size()) {
                            throw new Exception("out of range!!!!!");
                        } else if (!th_list.list.remove(id)) {
                    ...
                    case "8":
                        ...
                        ThreadList.TaskFreshList.fresh(th_list);
                        break;
                    default:
